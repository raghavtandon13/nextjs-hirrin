    ...
    <>
      <div className="fixed w-full flex h-[70px] bg-gray-100 border-b border-gray-300 dark:bg-background dark:border-gray-700">
        <div className="flex flex-1 items-center justify-center">
          <Link href="/">
            <h1 className="text-2xl font-clash sm:text-4xl font-black dark:text-white">HIRR.IN</h1>
          </Link>
        </div>
        ...
        <div className={`fixed transition-all duration-300 top-0  ${isDrawerOpen ? "right-0" : "right-[-60vw]"} bottom-0 w-[60vw] bg-gray-100 border-l border-gray-300 dark:bg-zinc-900 dark:border-gray-700`}>
